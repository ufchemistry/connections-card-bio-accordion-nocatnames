...
/**
 * @package    Connections
 * @subpackage Template : Bio Card Accordion No Category Names
 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Connections Bio Card Accordion No Category Names - Template
...
function getHtmlTagArrayAccNoCatNames($htmlTag) {
	...
	return($htmlTagArray);
} ##END function getHtmlTagArrayAccNoCatNames($imgTag)


function cn_remove_list_no_result_message5() {
    remove_action( 'cn_list_no_results', array( 'cnTemplatePart', 'noResults' ), 10 );
}

add_action( 'plugins_loaded', 'cn_remove_list_no_result_message5', 12 );


if ( ! class_exists( 'CN_Bio_Card_Accordion_Nocatnames_Template' ) ) {

	class CN_Bio_Card_Accordion_Nocatnames_Template {

		public static function register() {

			$atts = array(
				'class'       => 'CN_Bio_Card_Accordion_Nocatnames_Template',
				'name'        => 'Bio Entry Accordion Nocatnames Card',
				'slug'        => 'card-bio-accordion-nocatnames',
				'type'        => 'all',
				'version'     => '2.0.1',
				'author'      => 'Steven A. Zahm',
...
## remove this to get rid of duplicate "custom" field listings 2/24/2015 by SMK
 ...
 ?>
	...
	add_action( 'cn_register_template', array( 'CN_Bio_Card_Accordion_Nocatnames_Template', 'register' ) );
}
